...
type AwardBadgeType = "golden-kitty" | "product-of-the-day" | "product-of-the-month" | "product-of-the-week" | "nyota-best";
...
const title = {
  ...
  "nyota-best": "Best Wedding Invites",
};
    ...
    >
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 54" className="w-[180px] sm:w-[260px] h-auto">
          ...
          <text fontFamily="Helvetica-Bold, Helvetica" fontSize="9" fontWeight="bold" fill="#0E0E0E" x="53" y="20" letterSpacing={type === "nyota-best" ? "1" : "0"}>
            {type === "nyota-best" ? "✦ NYOTA" : "PRODUCT HUNT"}
          </text>
          <text fontFamily="Helvetica-Bold, Helvetica" fontSize={type === "nyota-best" ? "15" : "16"} fontWeight="bold" fill="#0E0E0E" x="52" y="40">
            {title[type]}{place && ` #${place}`}
          </text>
          <g transform="translate(8, 9)">
            <path fill={type === "nyota-best" ? "#0E0E0E" : "#666"}
